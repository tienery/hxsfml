...
extern class Vector2i extends Vector2<Int> {
    //Constructors
    @:native("sf::Vector2i")         public static function createInstance(x:Int, y:Int):Vector2i;
...
extern class Vector2f extends Vector2<Float> {
    //Constructors
    @:native("sf::Vector2f")         public static function createInstance(x:Float, y:Float):Vector2f;
...
extern class Vector2u extends Vector2<UInt> {
    //Constructors
    @:native("sf::Vector2u")         public static function createInstance(x:UInt, y:UInt):Vector2u;
